    ...
    return (
        <>
            ...
            <section className="relative h-[600px] flex items-center justify-center bg-gray-900 text-white overflow-hidden">
                {/* We would replace this with a real campus image or DSC_4763 from the media library */}
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 slide-in-bottom">{home.heroTitle}</h1>
                    <p className="text-lg md:text-2xl mb-8 font-light text-gray-200">{home.heroSubtitle}</p>
                    <div className="flex space-x-4 justify-center">
                        <Link href="/admission" className="btn-secondary text-lg px-8 py-3">
                            Apply Now
                        </Link>
                        <Link href="/courses" className="bg-white text-primary hover:bg-gray-100 font-semibold py-3 px-8 rounded-md transition-colors duration-200">
                            Explore Courses
                        </Link>
                    </div>
                </div>
            ...
            <section className="py-16 bg-white">
                <div className="container-custom grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <Link href="/about" className="text-primary font-semibold hover:text-secondary-dark flex items-center transition-colors">
                            Read More
